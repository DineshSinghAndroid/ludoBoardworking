...
import 'package:ludoboardworking/board/board.dart';
import 'package:ludoboardworking/players/collision_details.dart';
import 'package:ludoboardworking/dice/dice_notifier.dart';
import 'package:ludoboardworking/board/overlay_surface.dart';
import 'package:ludoboardworking/util/colors.dart';
import 'package:ludoboardworking/players/players.dart';
import 'package:ludoboardworking/result/result.dart';
import 'package:ludoboardworking/result/result_notifier.dart';
import 'package:flutter/material.dart';
import 'package:flutter/services.dart';
import 'package:provider/provider.dart';
import 'package:ludoboardworking/players/players_notifier.dart';
...
class _FludoGameState extends State<FludoGame> with TickerProviderStateMixin {
 ...
 late List<List<AnimationController>> _playerAnimContList = [];
 late List<List<Animation<Offset>>> _playerAnimList = [];
 late List<List<int>> _winnerPawnList = [];
 late bool _provideFreeTurn = false;
                          ...
                          SizedBox.expand(
                            ...
                            builder: (_, __) => CustomPaint(
                              painter: OverlaySurface(
                                  highlightColor: _playerHighlightAnim.value??Colors.blue,
